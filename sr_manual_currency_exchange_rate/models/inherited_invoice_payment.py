...
class AccountPayments(models.Model):
    ...
    def _prepare_move_line_default_vals(self, write_off_line_vals=None):
        ...
        # SE ADAPTO EL CODIGO PARA EL MODULO DE MULTIPAGOS
        for rec in self:
            if rec.invoice_lines:
                ...
                if rec.active_manual_currency_rate:
                    if rec.apply_manual_currency_exchange:
                        liquidity_balance = liquidity_amount_currency / rec.manual_currency_exchange_rate
                        write_off_balance = write_off_amount_currency / rec.manual_currency_exchange_rate
                    else:
